...
The code rpg generates (simply-connected and multiply-connected) polygons on a
set of user-specified or randomly generated polygons. RPG 3.0 is a revived and
clean-up version of C code fragments that were implemented during the course
...
Please see the following publication for details on the algorithms:
   ...
   Proc. 8th Canadian Conference on Computational Geometry (CCCG'96),
   pages 38-43, 1996. 
   http://www.cccg.ca/proceedings/1996/cccg1996_0006.pdf. 
We have the following correspondence to the algorithms described in this
paper:
