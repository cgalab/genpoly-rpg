...
-MAXnarrow      max. cosine in initial hull that sets qh NARROWhull
                If qh NARROWhull, the initial partition does not make 
                coplanar points.  If narrow, a coplanar point can be 
                coplanar to two facets of opposite orientations and
                distant from the exact convex hull.
               
-WARNnarrow     max. cosine in initial hull to warn about qh NARROWhull
*/
...
#define qh_RATIOnearinside 5  /* ratio of distance for NEARinside to ONEmerge 
                                 this effects whether 'Qc' reports all coplanar points */
...
#define qh_MAXnarrow -0.98   /* -cos(0.2) for about 1:10 ratio between */
                             /* coplanar point and distance to exact hull */
#define qh_WARNnarrow -0.9999 /* to warn about qh_MAXnarrow.  In practise
                                 problems never seen until much narrower */
