		  ...
		  t_point line2point1, t_point line2point2)
{
  ...
  /* now that we have assured that the points will always be in the 
     same order, we can do the testing */
  result = isectOrderedSegments(line1point1, line1point2, line2point1, 
                             line2point2);  
  return(result);  
}
                         ...
                         t_point line2point1, t_point line2point2)
{
   ...
   if ((xmax1 < xmin2) ||
      ...
      if ((res1 = posL1P1*posL1P2) == 1)  {
         ...
         /* test if either a and b lie on one side of (c, d) or vice versa */
