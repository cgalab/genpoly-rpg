/* set.h -- header file for set.c that implements set
   ...
   see COPYING_Qhull.txt and set.c
...
-SETindex_(set, elem, type)- returns index for iterated elem in set
*/
...
/*-----------------------------------------------
-SETelem_(set, n)- set the n'th element of set
-SETelemt_(set, n, type)- return the n'th element of set
