/* merge.c - merges non-convex facets
   ...
   see COPYING_Qhull.txt and merge.h
...
void qh_mergevertices2d(setT *vertices1, setT *vertices2) {
  ...
  vertex1A= SETfirstt_(vertices1, vertexT);  
  vertex1B= SETsecondt_(vertices1, vertexT);  
  vertex2A= SETfirstt_(vertices2, vertexT);  
  vertex2B= SETsecondt_(vertices2, vertexT);  
