/* qhull.h -- user-level header file for using qhull.a library
   ...
   see COPYING_Qhull.txt, qhull_a.h
...
#ifndef __STDC__ 
#ifndef __cplusplus
#error  neither __STDC__ nor __cplusplus are defined.  Please use ANSI C or C++ to compile Qhull.
#endif
#endif
...
typedef enum {qh_PRINTnone= 0, qh_PRINTarea, qh_PRINTaverage, 
  ...
  qh_PRINTtriangles, qh_PRINTvertices, qh_PRINTvneighbors, 
...
struct qhT {
  ...
  realT MAXlowcoord;       /* max coordinate in all but last dimension */
