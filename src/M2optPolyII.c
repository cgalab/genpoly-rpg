...
int checkAndUntangle(  t_edgeIArray *edgeArray, t_binArray *isectArray, 
...
void MnewDo2optMoves(t_polygon *aPolygon, t_pointArray *pArray, int nrOfPoints, 
                     int mode)
{
   int index, index11, index12, index21, index22, i1, i2, untangled, notangle;  
   int count, count2, sel2, dirty, dsect;  
   int randomIndex, oldIndex, isects;  
   ...
   nodeList *lines;  
   int no_work = 1;
   listNode *li1, *li2, *li1next, *li2next, *ltmp;  
         ...
         if (EAvalidateEdge(&edgeArray, ((lineElement *)li1->data)->lc->lineNumber +1, 
            ...
            while (li2 != NULL) {
               ...
               if (EAvalidateEdge(&edgeArray, ((lineElement *)li2->data)->lc->lineNumber+1 , 
                  ...
                  untangled = checkAndUntangle(&edgeArray, &isectArray, &isectCount, &lPoly, pArray, 
